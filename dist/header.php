...
<head>
    ...
    if(is_singular() && get_the_tags()) {
        $tags = array_merge(['нейросети', 'создать нейросеть', 'нейронные сети'], array_map(function(WP_Term $tag) {
            return $tag->name;
        }, get_the_tags()));
    } else {
        $tags = ['нейросети', 'создать нейросеть', 'нейронные сети', 'нейронные сети учебник', 'нейронные сети уроки', 'искусственный интеллект', 'нейросети портал', 'нейронные сети портал'];
    }
